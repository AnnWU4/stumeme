...
{
    protected $noNeedLogin = ['login', 'mobilelogin', 'register', 'resetpwd', 'changeemail', 'changemobile', 'third', 'info', 'modify'];
    ...
    public function info(){
        $id = $this->request->param('user_id', 0);

        $userModel = (new \app\admin\model\User());
        $user = $userModel->where('id', '=', $id)->field('id,nickname,avatar,openid')->find();
